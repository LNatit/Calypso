...
public class InventoryRegistry
{
    ...
    public static final RegistryObject<MenuType<CapacityFurnaceMenu>> CAPACITY_FURNACE = MENUS.register(
            "capacity_furnace", () -> new MenuType<>(CapacityFurnaceMenu::new, FeatureFlags.DEFAULT_FLAGS));
    public static final RegistryObject<MenuType<RecycleBinMenu>> RECYCLE_BIN = MENUS.register(
